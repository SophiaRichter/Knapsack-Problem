...
public class Solution implements LearningAlgorithm
{
	...
	private void initialize() {
		...
		State s = new State(Integer.MAX_VALUE);		// The error state shall be the maximum of an Integer value
		for(Element e : sack) {
			for(int j=0; j<KnapsackGame.WIDTH; j++)
			{
				for(int k=0; k<KnapsackGame.HEIGHT; k++)
	...
	@Override
	public void feedback(State previousFieldState, State newFieldState, Action action, double reward, boolean finalState) 
	{
