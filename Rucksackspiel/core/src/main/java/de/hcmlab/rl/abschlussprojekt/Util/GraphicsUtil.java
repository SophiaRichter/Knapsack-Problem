...
public class GraphicsUtil {
    ...
    public static void drawCentered(SpriteBatch sb, Texture tex, int x, int y, int cellWidth, int cellHeight) {
        drawCentered(sb, tex, x, y, cellWidth, cellHeight, 0);
    }

    public static void drawCentered(SpriteBatch sb, Texture tex, int x, int y, int cellWidth, int cellHeight, float rotation) {
